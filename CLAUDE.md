# scale_gad7 — Claude Session Context

> **Category:** database · **License:** Free-with-attribution · **HIPAA:** none
>
> **Registry entry:** [meta/ecosystem.yaml#scale_gad7](https://github.com/Creeden-Enterprise/creeden_enterprise_hub/blob/main/meta/ecosystem.yaml)

---

## Role in ecosystem

GAD-7 anxiety screening scale (7 items; attrib tier).

## Current state

_Last refreshed: 2026-07-04 — run `creeden_enterprise scaffold scale_gad7 --refresh` to update._

<!-- preserve:start current_state -->
Registry marks this repo as **active**. Author a sentence or two describing the point-in-time state when this snapshot was refreshed — what works, what's partially done, what's pending. Use `creeden_enterprise scaffold scale_gad7 --refresh` to rerun the snapshot.
...
```bash
cd C:/Users/justi/code/active/scale_gad7
git pull --rebase origin master
creeden_enterprise doctor scale_gad7
```
...
- This repo in registry: [meta/ecosystem.yaml#scale_gad7](https://github.com/Creeden-Enterprise/creeden_enterprise_hub/blob/main/meta/ecosystem.yaml)
